function [u,H,beta,x,fi,psi,wght,bwght,dudC]=Hum(N,xL,H0,HGL,iGL,ist,C,rhoig,a,Hcfact)
...
for i=1:ist
    ...
    psi(i)=-1/Hst+C*fic*((a*x(i))^m-axstm);
    wght(i)=-fi(i)*u(i)^m;
    bwght(i)=m1*C*a*xst*(a*x(i))^m/(rhoig*Hst^m3*H(i));
end
